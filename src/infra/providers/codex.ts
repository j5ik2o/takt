...
function toCodexOptions(options: ProviderCallOptions): CodexCallOptions {
  return {
    ...
    sandboxMode: options.providerOptions?.codex?.sandboxMode,
    networkAccess: options.providerOptions?.codex?.networkAccess,
    approvalPolicy: options.providerOptions?.codex?.approvalPolicy,
    additionalDirectories: options.providerOptions?.codex?.additionalDirectories,
